...
![SI-NI-FGSM 算法](https://i.loli.net/2020/05/21/7Rz5LAZGpHMxjmd.png)
...
![不同缩放比例下模型 Inc-v3、Inc-v4、IncRes-2 和 Res-101 的平均 loss](https://i.loli.net/2020/05/21/VWQgaZLy17M8w4C.png)
...
![攻击单个模型的成功率](https://i.loli.net/2020/05/21/1nKzOjHiyLVpdaw.png)
...
![攻击集成模型的成功率](https://i.loli.net/2020/05/21/7Rd6wCTiubJ1NLX.png)
...
![攻击其他防御模型](https://i.loli.net/2020/05/21/god9WA2Sitpr4El.png)
...
![NI-FGSM 和 MI-FGSM迭代 4 至 16 次生成对抗样本迁移攻击成功率](https://i.loli.net/2020/05/21/HBAIObVTGRqUjM7.png)
...
![和传统攻击算法性能对比](https://i.loli.net/2020/05/21/8mAZ4U1edhSENwf.png)
